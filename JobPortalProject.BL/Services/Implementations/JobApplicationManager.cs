...
namespace JobPortalProject.BL.Services.Implementations
{
        ...
        , IJobApplicationService
    {
        ...
        {
            if (entity.Candidate == null || entity.Candidate.Resume == null)
                return null!;
        ...
        public async Task<ApplicantsOfJobViewModel> GetApplicantsViewModel(int jobId)
        {
            ...
            model.TotalApplicantsCount = entities.Count();
            model.InterviewCount = entities.Where(x => x.JobStatus.ToString() == "interview").Count();
            model.RejectedCount = entities.Where(x => x.JobStatus.ToString() == "rejected").Count();
            model.AcceptedCount = entities.Where(x => x.JobStatus.ToString() == "accepted").Count();

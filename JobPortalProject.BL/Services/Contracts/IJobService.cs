...
namespace JobPortalProject.BL.Services.Contracts
{
    ...
    {
        public Task<bool> CreateJobAll(int companyId, JobCreateAllViewModel model);
        public Task<JobCreateAllViewModel> GetJobCreateAllViewModelAsync(int companyId);
        public Task<bool> AddTranslationToJob(int jobId, AddTranslationToJobViewModel model);
        public Task<AddTranslationToJobViewModel> GetAddTranslationToJobViewModel(int jobId, int languageId);
        ...
        public Task<JobCreateViewModel> GetJobCreateViewModelAsync(int companyId, int languageId);
